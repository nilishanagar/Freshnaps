...
const AboutPage = () => (
  <div className="min-h-screen bg-white dark:bg-navy-900">
    ...
    <section className="py-20 container-custom">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
          <span className="text-gold-500 font-medium text-sm uppercase tracking-widest">Since 2020</span>
    ...
    {/* Values */}
    <section className="py-16 bg-cream-200 dark:bg-navy-800/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <motion.div key={title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1 }} viewport={{ once: true }} className="card p-8 text-center">
              <div className="w-14 h-14 rounded-2xl bg-gold-gradient flex items-center justify-center mx-auto mb-5">
    ...
    {/* Stats */}
    <section className="py-16 bg-navy-900 dark:bg-navy-950 text-white">
      <div className="container-custom grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
        {[
          ...
          <div key={label}>
            <p className="font-display text-4xl font-bold text-gold-400 mb-1">{num}</p>
