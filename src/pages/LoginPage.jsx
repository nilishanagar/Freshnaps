    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-50/20 dark:bg-surface-950 px-4 py-20 select-none">
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        >
          ...
          <div className="flex border border-surface-100 dark:border-surface-900 p-1 rounded-2xl bg-surface-50/30 dark:bg-surface-950 mb-6">
            <button
              type="button"
              ...
              className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-xs font-extrabold transition-all cursor-pointer ${
                activeTab === 'otp'
                  ...
                  : 'text-gray-500 hover:text-surface-600 dark:text-gray-400 dark:hover:text-primary-400'
              }`}
            >
              <Mail size={14} />
              <span>Email OTP</span>
                ...
                {!otpSent ? (
                  ...
                  <form onSubmit={handleSubmit(onVerifyOtpSubmit)} className="space-y-4">
                    <div className="p-3 bg-surface-50/20 dark:bg-surface-950 border border-surface-100 dark:border-surface-900 rounded-2xl text-[11px] leading-relaxed text-gray-500 flex gap-2">
                      ...
                      <div>
                        Verification code sent to <span className="font-extrabold text-surface-600 dark:text-primary-400">{targetEmail}</span>. Check your inbox (and spam folder).
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-xs">
                      <button
                        ...
                        className="text-gray-400 font-extrabold hover:text-surface-600 uppercase tracking-wider text-[10px] cursor-pointer"
                        disabled={verifyingOtp}
                      >
                        Change Email
                      </button>
            ...
            {activeTab === 'password' && (
              ...
              >
                <form onSubmit={handleSubmit(onPasswordSubmit)} className="space-y-4">
                  ...
                  <div className="flex justify-end text-xs font-bold text-primary-600 hover:text-primary-700 select-none cursor-pointer">
          ...
          <p className="text-center text-xs font-semibold text-gray-500 mt-6">
            ...
            <Link to="/register" className="text-primary-600 font-extrabold hover:underline uppercase tracking-wide">Create one</Link>
          </p>
