...
const CancelOrderModal = ({ isOpen, onClose, onConfirm, loading = false }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm select-none">
      <div className="bg-white dark:bg-navy-600 rounded-3xl w-full max-w-md overflow-hidden shadow-gold-lg border border-cream-200 dark:border-navy-700/60 transition-all duration-300 animate-slide-up">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full px-3 py-2.5 text-sm rounded-xl border border-cream-300 dark:border-navy-700 bg-cream-50/20 dark:bg-navy-800 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-transparent text-gray-700 dark:text-gray-200 transition-all cursor-pointer"
            >
          ...
          {reason === 'Other reasons' && (
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                required
                className="w-full px-3 py-2 text-sm rounded-xl border border-cream-300 dark:border-navy-700 bg-cream-50/20 dark:bg-navy-800 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-transparent text-gray-700 dark:text-gray-200 transition-all resize-none placeholder-gray-400"
              />
            </div>
          )}
